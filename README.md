...
All core credit for the editor, its original design, and the original public release belongs to FINDarkside.

This fork exists to keep the editor working with the most recent known The Long Dark save format supported by this repository as of the current maintenance work.
...
- keep the project buildable and releasable on current Windows environments
